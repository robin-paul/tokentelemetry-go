...
When running in an interactive terminal, it presents a live stream. In daemon mode (--daemon) or
non-interactive shells (CI/background), it runs as a headless structured slog logger.`,
