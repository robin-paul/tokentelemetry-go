...
**Read the `refactor-values` skill** (`.cursor/skills/refactor-values/SKILL.md`) before modifying any existing static-data file or enum value. It owns the impact-analysis + cascading-update workflow.
