...
Read the full workflow in the `selectors` skill (`.cursor/skills/selectors/SKILL.md` → "Exploration-First Workflow") and `playwright-cli` skill for the specific commands.
