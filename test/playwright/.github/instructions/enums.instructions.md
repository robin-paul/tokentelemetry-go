...
1. Read the `playwright-cli` skill instructions.
...
**Read the `refactor-values` skill instructions** **before** touching an existing enum. It owns the impact-analysis and cascading-update workflow.
